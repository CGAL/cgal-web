...
<LI> A new kernel called <TT>Simple_homogeneous</TT> is available. It is
     equivalent to <TT>Homogeneous</TT> but without reference-counted objects. </li>
...
<UL>
  ...
  <LI> A new <TT>convex_hull_incremental_3</TT> function based on the new
       d-dimensional convex hull class is available for comparison purposes. </li>
</UL><BR>
 </li>
...
<LI> A new package offering functions to
     ...
     convex and y-monotone pieces is available. </li>
 </li>
     <BR><BR>
<LI>
     Planar Maps and
     ...
     <LI> New arrangement traits class for line segments and circular arcs
          (<TT>Arr_segment_circle_traits&lt;NT&gt;</TT>). </li>
     ...
     <LI> A new point location strategy
          (<TT>Pm_simple_point_location&lt;Planar_map&gt;</TT>). </li>
     </UL>
     </li>
     <BR><BR>
...
<LI>
     ...
     <LI> Additionnal functionality: </li>
     <UL>
...
<LI> Point_set_2
    <UL>
    <LI>  now independent of LEDA; based on the CGAL Delaunay triangulation </li>
