---
layout: post
title: "CGAL 4.12 beta2 released"
description: "CGAL 4.12 beta2"
category: 
tags: ["beta-release"]
---
{% include JB/setup %}
...
<a href="https://github.com/CGAL/cgal/releases/tag/releases%2FCGAL-4.12-beta2">Download CGAL-4.12-beta2</a>

<i class="glyphicon glyphicon-book"></i>
<a href="https://doc.cgal.org/4.12/Manual/index.html">CGAL-4.12-beta2 documentation</a>
...
-   Added a callback mechanism for both `CGAL::Efficient_RANSAC` and
    `CGAL::Region_growing`.
