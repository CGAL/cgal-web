...
latest <code class="language-plaintext highlighter-rouge">master</code> or development branch in the repository.</p>
  </li>
  <li>
    <p><strong>Isolate the problem</strong> — make sure that the code in the repository is
<em>definitely</em> responsible for the issue.</p>
  </li>
</ol>
...
important, please try to provide them.</p>
...
<p>Please adhere to the coding conventions used throughout the project (indentation,
comments, etc.).</p>
...
<ol>
  <li>
    <p><a href="http://help.github.com/fork-a-repo/">Fork</a> the repo, clone your fork,
and configure the remotes:</p>

    <div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c"># Clone your fork of the repo into the current directory</span>
git clone https://github.com/&lt;your-username&gt;/&lt;repo-name&gt;
<span class="c"># Navigate to the newly cloned directory</span>
<span class="nb">cd</span> &lt;repo-name&gt;
<span class="c"># Assign the original repo to a remote called "upstream"</span>
git remote add upstream https://github.com/&lt;upsteam-owner&gt;/&lt;repo-name&gt;
  ...
  <li>
    ...
    <div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code>git checkout &lt;dev-branch&gt;
...
contain your feature, change, or fix:</p>
    ...
    <div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code>git checkout <span class="nt">-b</span> &lt;topic-branch-name&gt;
</code></pre></div>    </div>
  </li>
  <li>
...
feature to tidy up your commits before making them public.</p>
  ...
  <li>
    ...
    <div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code>git pull <span class="o">[</span><span class="nt">--rebase</span><span class="o">]</span> upstream &lt;dev-branch&gt;
</code></pre></div>    </div>
  </li>
  <li>
    <p>Push your topic branch up to your fork:</p>

    <div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code>git push origin &lt;topic-branch-name&gt;
</code></pre></div>    </div>
  </li>
  <li>
