...
<p><strong>readable-stream</strong> uses proper patch-level versioning so if you pin to <code class="language-plaintext highlighter-rouge">"~1.0.0"</code> you’ll get the latest Node 0.10 Streams2 implementation, including any fixes and minor non-breaking improvements. The patch-level versions of 1.0.x and 1.1.x should mirror the patch-level versions of Node-core releases. You should prefer the <strong>1.0.x</strong> releases for now and when you’re ready to start using Streams3, pin to <code class="language-plaintext highlighter-rouge">"~1.1.0"</code></p>
